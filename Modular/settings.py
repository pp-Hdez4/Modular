"""
Django settings for Modular project.
...
SECRET_KEY = 'django-insecure-h%4*n%tf6m4ln4&kmf$9jry3*=n7&=66xj+l@(h%+5&9yz_ms^'
...
DATABASES = {
    'default': {
        ...
        'PORT': '3306',       # Puede ser diferente según tu configuración
    }
}
